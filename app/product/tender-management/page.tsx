            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                    <div className="bg-slate-50 p-8 rounded-xl">
                        ...
                        <p className="text-slate-600">Respond to RFQs with a single click. Our templates make it easy to submit complex bids with Incoterms and volume tiers.</p>
                    </div>
                    <div className="bg-slate-50 p-8 rounded-xl">
                        <h3 className="text-2xl font-bold text-slate-900 mb-4">Order Management</h3>
                        <p className="text-slate-600">Track awarded contracts and spot orders in one unified dashboard. Integrate with your ERP for seamless fulfillment.</p>
                    </div>
                </div>
            </div>
        </div>
