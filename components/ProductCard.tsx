        ...
        >
            <div className="flex justify-between items-start mb-4">
                <div>
                    ...
                    <p className="text-sm text-black dark:text-slate-400 font-mono">CAS: {product.cas_number}</p>
                </div>
            ...
            <div className="space-y-3">
                <div className="flex items-center text-sm text-black dark:text-slate-400">
                    <FlaskConical className="w-4 h-4 mr-2 text-slate-400 dark:text-black" />
            ...
            <div className="mt-6 pt-4 border-t border-slate-100 dark:border-slate-800 flex justify-between items-center">
                <div className="text-xs text-slate-400 dark:text-black">
                ...
                {onSelect ? (
                    <button
                        className={`px-4 py-2 text-sm font-medium rounded-lg transition-colors ${isSelected
                            ...
                            : 'bg-slate-100 dark:bg-slate-800 text-black dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700'
                            }`}
                    >
