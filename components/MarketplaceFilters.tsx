        ...
        <div className="bg-white dark:bg-slate-900 p-4 rounded-xl shadow-sm border border-slate-200 dark:border-slate-800 mb-6">
            <div className="flex flex-col md:flex-row gap-4">
                ...
                <div className="flex gap-2">
                    <button className="flex items-center px-4 py-2 border border-slate-200 dark:border-slate-800 rounded-lg hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-600 dark:text-slate-400">
                        <Filter className="w-4 h-4 mr-2" />
                        Filters
                    </button>
                    <select
                        className="px-4 py-2 border border-slate-200 dark:border-slate-800 rounded-lg bg-white dark:bg-slate-950 text-slate-600 dark:text-slate-400 focus:outline-none focus:ring-2 focus:ring-teal-500"
                        onChange={(e) => {
                            const params = new URLSearchParams(searchParams);
